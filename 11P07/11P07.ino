...
#define _DIST_LOW 180
#define _DIST_HIGH 360
...
// adjust servo position according to the USS read value
  ...
  if(dist_raw <= _DIST_LOW) {
     myservo.writeMicroseconds(_DUTY_MIN);
  }
  else if(dist_raw > _DIST_LOW && dist_raw < _DIST_HIGH){
     myservo.writeMicroseconds(((dist_raw - _DIST_LOW) / _DIST_LOW) * (_DUTY_MAX - _DUTY_MIN) + _DUTY_MIN);
