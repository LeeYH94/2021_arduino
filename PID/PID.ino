...
// Servo range
#define _DUTY_MIN 1365    // 서보 duty 최소값
#define _DUTY_NEU 1565    // 서보 duty 중간값
#define _DUTY_MAX 1765    // 서보 duty 최댓값

// Servo speed control
#define _SERVO_ANGLE 30       // 서보 각도
#define _SERVO_SPEED 100     // 서보의 속도
...
////////////////////
  ...
  // duty_target = f(duty_neutral, control)
    duty_target = _DUTY_NEU + control - 50; 

  // keep duty_target value within the range of [_DUTY_MIN, _DUTY_MAX]
  if(duty_target < _DUTY_MIN){
    duty_target = _DUTY_MIN - 50;
  } 
  if(duty_target > _DUTY_MAX){
    duty_target = _DUTY_MAX - 50;
  } 
